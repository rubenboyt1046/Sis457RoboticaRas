...
namespace Sis457RoboticaRas.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ProductosController(RoboticaRasContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProducto,IdCategoria,Codigo,Nombre,UrlImagen,Descripcion,Precio,UsuarioRegistro,FechaRegistro,Estado")] Producto producto)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RoboticaRasContext.Productos'  is null.");
            }
            var producto = await _context.Productos.FindAsync(id);
            if (producto != null)
            {
